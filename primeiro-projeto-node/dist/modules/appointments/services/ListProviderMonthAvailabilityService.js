    ...
    ListProviderMonthAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.appointmentsRepository.findAllInMonthFromProvider({ provider_id: provider_id, year: year, month: month })];
                    case 1:
                        ...
                        availability = eachDayArray.map(function (day) {
                            ...
                            return { day: day, available: appointmentsInDay.length < 10 };
                        });
