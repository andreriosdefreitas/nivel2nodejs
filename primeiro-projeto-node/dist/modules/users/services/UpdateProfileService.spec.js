...
describe('UpdateProfile', function () {
    ...
    it('should not be able to update the password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
    ...
    it('should not be able to update non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(updateProfileService.execute({
                        user_id: uuidv4_1.uuid(),
                        name: 'Joao Silva',
                        email: 'joao@test.com',
                    })).rejects.toBeInstanceOf(AppError_1.default)];
                case 1:
