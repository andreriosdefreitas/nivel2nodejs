...
describe('SendForgotPasswordEmail', function () {
    beforeEach(function () {
        ...
        sendForgotPasswordEmailService = new SendForgotPasswordEmailService_1.default(fakeUsersRepository, fakeMailProvider, fakeUserTokensRepository);
    });
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, sendForgotPasswordEmailService.execute({ email: user.email })];
                case 2:
                    _a.sent();
