...
var FakeUsersRepository_1 = __importDefault(require("../repositories/FakeUsersRepository"));
...
describe('UpdateUserAvatar', function () {
    ...
    it('should not be able to update the user avatar with non exist user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should deleete old avatar when updating new one', function () { return __awaiter(void 0, void 0, void 0, function () {
        var deleteFile, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
